...
Configure with environment variables (all optional except ``SE_MODULES``):
    ...
    SE_FORMAT        comma-separated: json,mermaid (default: json,mermaid)
...
def main() -> int:
    ...
    options = Options.from_dict({
        ...
        # Phase 0 does not implement the physical/pg_catalog layer yet
        # (PLAN.md, phase 2) - always off here regardless of env.
        'physical': False,
    })
